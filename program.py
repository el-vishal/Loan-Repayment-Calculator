...
while True: #Keep application open
    ...
    event, button, values = main_window.Read()  # Reading user input data from GUI text boxes
    ...
    if user_input[3] is None and _RADIO1_ is None:
        sg.Popup('Please tick Radio Button')
        break
    ...
    window.FindElement('_RADIO1_').Update(fahrenheit)
